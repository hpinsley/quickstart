// Type definitions for Angular v2.0.0-local_sha.f1cf529
...
declare module "angular2/angular2" {
  ...
  class Injector {
    ...
    parent: Injector;
    strategy: any;
    hydrate(parent: Injector, host: Injector, ei: any): any;
    dehydrate(): void;
   ...
   * ```
   */
  function HttpFactory(backend: XHRBackend, defaultOptions: BaseRequestOptions);
